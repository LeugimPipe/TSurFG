...
func init(_v0 : Vertex, _v1 : Vertex, _v2 : Vertex) -> void:
	v0 = globals.VIS_TRANSFORM_2D*Vector2(_v0.coords.get_i(0), _v0.coords.get_i(1))
	v1 = globals.VIS_TRANSFORM_2D*Vector2(_v1.coords.get_i(0), _v1.coords.get_i(1))
	v2 = globals.VIS_TRANSFORM_2D*Vector2(_v2.coords.get_i(0), _v2.coords.get_i(1))
...
func on_v0_changed(coords : VectorN) -> void:
	v0 = Vector2(coords.get_i(0), coords.get_i(1))
	queue_redraw()
	
func on_v1_changed(coords : VectorN) -> void:
	v1 = Vector2(coords.get_i(0), coords.get_i(1))
	queue_redraw()

func on_v2_changed(coords : VectorN) -> void:
	v2 = Vector2(coords.get_i(0), coords.get_i(1))
	queue_redraw()
